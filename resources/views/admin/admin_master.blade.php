...
<head>
    ...
    <title>Sakthi - Admin Dashboard</title>
    <!-- GOOGLE FONTS -->
    ...
    <div class="page-wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li>
                                    <a href="{{ route('admin.change.profile') }}">
        ...
        <footer class="footer mt-auto">
            <div class="copyright bg-white">
                <p>
                    &copy; <span id="copy-year">2019</span> Copyright Sakthi Dashboard Bootstrap Template by
                    <a
                        class="text-primary"
                        href="https://github.com/Sakthi002"
                        target="_blank"
                    >Sakthi</a>.
                </p>
            </div>
