                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/about/update/'.$about->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="about_s_desc" rows="3" name="short_desc">{{ $about->short_desc }}</textarea>
                                @error('short_desc')
                                <span class="mt-2 d-block text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="about_l_desc" rows="5" name="long_desc">{{ $about->long_desc }}</textarea>
                                @error('long_desc')
                                <span class="mt-2 d-block text-danger">{{$message}}</span>
                                @enderror
                            </div>
